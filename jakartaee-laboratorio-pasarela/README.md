...
Once the runtime starts, you can access the project at [http://localhost:8080/jakartaee-laboratorio-pasarela](http://localhost:8080/jakartaee-laboratorio-pasarela).
...
```
./mvnw clean package
docker build -t jakartaee-laboratorio-pasarela:v1 .
```

You can then run the Docker image by executing:

```
docker run -it --rm -p 8080:8080 jakartaee-laboratorio-pasarela:v1
```
